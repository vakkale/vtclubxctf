const articles = [
    {
        ...
        content: <>
            ...
            <p>I'll leave a link to it <a href="https://chat.openai.com/">here</a> so you can see for yourself and this is also my first time testing external links from articles so hopefully that worked.</p>
