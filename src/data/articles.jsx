...
const articles = [
  {
    ...
    image: "https://i.imgur.com/5eRZaVt.jpeg",
    content: (
      <div className="article-content">
        <h2>Want to Join the Best Rec Sports Club at Virginia Tech?</h2>
        <p>
          Whether you're into distance running, sprints, jumps, or throws —
          you're in the right place. We get it: college life is busy. That’s why
          nothing in our club is mandatory. You can come to practice, meets, and
          socials as your schedule allows. With that said, there are just
        ...
        <ul>
          ...
          <li>
            <p>
              Scroll down to “Cross Country/Track &amp; Field” and click Join
            </p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <p>
              Indoor/Outdoor Track Racing Dues (Spring): Prices will be
              announced
            </p>
          </li>
        </ul>
